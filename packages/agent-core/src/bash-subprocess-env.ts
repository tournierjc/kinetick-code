 ...
 *
 * Layer A — KCode runtime boundary strip. ALWAYS on, no escape hatch.
...
export const BASH_SUBPROCESS_SCRUB: readonly string[] = [
  ...
  // KCode-side additions — runtime-only integration tokens, no subprocess use
  'FIGMA_API_TOKEN',
  'FIGMA_TOKEN',
  'E2E_AUTH_TOKEN',
];
...
export function sanitizeBashSubprocessEnv(
  ...
  // Layer A — KCode boundary strip. Always on; allowlist deliberately ignored.
